<template>
  ...
  <div class="outputAlisar">
    ...
    <div class="dataOfData">
      <div class="depend">
        Depends on the last two plans that is the best numbers of each component
        in first plan
      </div>
      <div class="solarData">
        number of solar panels for first plan {{ this.solprice1 }} and price of
        solar panels for first plan {{ this.solnum1 }}
      </div>
      <div class="solarData">
        number of batteries for first plan {{ this.batnum1 }} and price of
        batteries for first plan {{ this.batprice1 }}
      </div>
      <div class="solarData">
        price of inverter for first plan {{ this.inv1 }}
      </div>
    </div>
    <div class="dataOfData">
      <div class="depend">
      ...
      <div class="solarData">
        number of solar panels for secound plan {{ this.solprice2 }} and price
        of solar panels for secound plan {{ this.solnum2 }}
      </div>
      <div class="solarData">
        number of batteries for secound plan {{ this.batnum2 }} and price of
        batteries for secound plan {{ this.batprice2 }}
      </div>
      <div class="solarData">
        price of inverter for secound plan {{ this.inv2 }}
      </div>
    </div>
  </div>
  <FooterHome />
...
export default {
  ...
  methods: {
    ...
    other() {
      axios
        .post("http://192.168.229.77:5006/api/v1/solar_suggest", this.data)
        .then((r) => {
          console.log(r);
          this.inv1 = r.data.I1[0];
          this.inv2 = r.data.I2[0];
          this.batnum1 = r.data.B1[2];
          this.batnum2 = r.data.B2[2];
          this.batprice1 = r.data.B1[3];
          this.batprice2 = r.data.B2[3];
          this.solnum1 = r.data.N1[0];
          this.solnum2 = r.data.N2[0];
          this.solprice1 = r.data.N1[1];
          this.solprice2 = r.data.N2[1];
        });
      //window.location.reload();
    },
    getData() {
